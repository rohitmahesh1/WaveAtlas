export function stageLabel(stage: string | null): string {
  ...
  const map: Record<string, string> = {
    ...
    ripple_extract_start: "Extracting tracks",
    ripple_extract_load_values: "Loading heatmap",
    ripple_extract_smoothing: "Segmenting heatmap",
    ripple_extract_seeding: "Tracing tracks",
    ripple_extract_tracking: "Tracing tracks",
    ripple_extract_deduping: "Removing duplicates",
    ripple_extract_saving: "Saving tracks",
    ripple_extract_done: "Tracks extracted",
